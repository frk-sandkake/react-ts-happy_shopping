...
export function Navbar() {
    return (
        <NavbarBs sticky="top" className='shadow-sm mb-4 navbar-dark header-x'>
            <Container>
                ...
                <div
                className="badge rounded-circle border border-dark bg-info text-dark position-absolute top-100 start-100 translate-middle py-2 fs-6"
                >2
                </div>
                </Button>
            </Container>
